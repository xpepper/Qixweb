...
public class TestFakeHttpServletRequest extends junit.framework.TestCase
{
    ...
    public void testSimulatePost() throws IOException, ClassNotFoundException
    {
        ...
        assertTrue("The object wasn't read correctly", ArrayComparator.areEquals(theExpectedObjects, (Object[]) theObjectInputStream.readObject()));
    }

    public void testSimulateRequestParameters()
    {
        FakeHttpServletRequest theRequest = new FakeHttpServletRequest(PropertiesUtil.with("ParamName", "Pippo", "ParamSurname", "Pappo", "ParamAge", "15"));
