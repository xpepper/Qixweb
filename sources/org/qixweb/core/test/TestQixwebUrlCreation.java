...
public class TestQixwebUrlCreation extends ExtendedTestCase
{
    ...
    public void testCostructorWithDefaultNodePackage()
    {
        ...
        assertEquals("the url should be composed without servlet path", "?command=RefreshableCommand", url.destination());
        ...
        assertEquals("the url should be composed using the servlet path", "http://localhost/MyWebApp/servlet/MyServlet?command=RefreshableCommand", url.destination());
    }
