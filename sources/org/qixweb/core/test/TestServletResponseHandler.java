...
public class TestServletResponseHandler extends ExtendedTestCase
{
    ...
    {
        String expectedHtml = "<A href=\"http://" + itsServletPath + "/" + itsPageID + "?param=value\">link</a>" + "<A href=\"http://servlet/ImportCSVServlet" + "/" + itsPageID
                + "?param=value\">csv link</a>" + "<A href=\"http://servlet/ScriptServlet" + "/" + itsPageID + "\">script link</a>" + "<h3>a title</h3><A href=\"http://" + itsServletPath + "/"
                + itsPageID + "?userName=pollo\">user name</a>";

        String html = "<A href=\"http://" + itsServletPath + "?param=value\">link</a>" + "<A href=\"http://servlet/ImportCSVServlet?param=value\">csv link</a>"
                + "<A href=\"http://servlet/ScriptServlet\">script link</a>" + "<h3>a title</h3><A href=\"http://" + itsServletPath + "?userName=pollo\">user name</a>";
