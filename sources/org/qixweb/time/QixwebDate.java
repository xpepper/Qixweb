...
public class QixwebDate extends QixwebCalendar
{
    ...
    {
        return new QixwebDate(Integer.parseInt(anUrl.get(aPrefix + DAY_PARAM)), Integer.parseInt(anUrl.get(aPrefix + MONTH_PARAM)), Integer.parseInt(anUrl.get(aPrefix + YEAR_PARAM)));
    }
