...
public class TestArrayComparator extends junit.framework.TestCase
{
	...
	public void testAreEqualsOnArraysOfIterators()
	{
		...
		assertFalse(
			"Arrays with the same elements but in a different order must be different",
			ArrayComparator.areEquals(new Iterator[] { list.iterator()}, new Iterator[] { listWithDifferentOrder.iterator()}));
