...
public class TestDeepEquals extends ExtendedTestCase
{
    ...
    {
        assertTrue("If this call goes in stack overflow means that it compare also static fields, that it's wrong", new ClassWithStaticField().equals(new ClassWithStaticField()));
    }
    ...
    {
        Student student = new Student("davide", "varvello", 32, new Integer[] { new Integer(30), new Integer(29), new Integer(28), new Integer(27) });
        Student sameStudent = new Student("davide", "varvello", 32, new Integer[] { new Integer(30), new Integer(29), new Integer(28), new Integer(27) });
        Student sameStudentWithMarksInDifferentOrder = new Student("davide", "varvello", 32, new Integer[] { new Integer(27), new Integer(30), new Integer(29), new Integer(28) });
        Student sutdentWithDifferentMarks = new Student("davide", "varvello", 32, new Integer[] { new Integer(33), new Integer(33), new Integer(28), new Integer(27) });

        assertEquals("the same student must be equals", student, sameStudent);

        assertFalse("two students with same marks but in different order must be different", student.equals(sameStudentWithMarksInDifferentOrder));
    ...
    public void testList()
    {
        ...
        assertFalse("two students with same marks but in different order must be different", student.equals(studentWithMarksInDifferentOrder));

        assertFalse("two students with different marks must be different", student.equals(studentWithDifferentMarks));
